<aside class="leftbar">
    <div class="left-aside-container">
        ...
        <ul class="list-accordion tree-style">
            ...
            <li><a href="ui-widgets.html"><i class="zmdi zmdi-widgets"></i><span class="list-label">Ui
                        Widgtes</span></a></li>
            ...
            <li><a href="grid.html"><i class="zmdi zmdi-border-all"></i><span class="list-label">Grid</span></a>
            </li>
