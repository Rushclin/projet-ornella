        ...
        <div class="container">
            <div class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4">
                <div class="login-form-container">
                    <form action="index.php?action=admin/login" method="POST" class="j-forms" id="forms-login">
                        ...
                        <div class="login-form-content">
                            ...
                            <div class="unit">
                                <div class="input login-input">
                                    ...
                                    <input class="form-control login-frm-input" type="text" id="login" name="login" placeholder="Login" value="<?= isset($login) ? $login : "" ?>">
                                </div>
                            </div>
                            <div class="unit">
                                <div class="input login-input">
                                    ...
                                    <input class="form-control login-frm-input" type="password" id="password" name="password" placeholder="Mot de passe" required>
                                    <!--<span class="hint">
